...
@dataclass
class Sector:
    """Dataclass para representar los sectores del sistema informático."""
    nombre: str
    dificultad: int

class Item(GameObject):
    """Representa las herramientas o parches de reparación."""
...
class Actor(GameObject):
    """Clase base para entidades con salud/integridad en el juego."""
...
class Player(Actor):
    """El personaje controlado por el usuario."""
